...
Original file is located at
    https://colab.research.google.com/drive/1_ucTwzNhm9lJyzzTiNMAwr2C0mmHix6k
"""
...
src_path = 'MUSE/dumped/debug/d512unsupervised/vectors-17.txt'
tgt_path = 'MUSE/dumped/debug/d512unsupervised/vectors-18.txt'
...
for tw in test_words:
  ...
  if tw in src_word2id.keys():
    dist = scipy.spatial.distance.cosine(src_embeddings[src_word2id[tw]], tgt_embeddings[tgt_word2id[tw]])
  elif tw.lower() in src_word2id.keys():
    dist = scipy.spatial.distance.cosine(src_embeddings[src_word2id[tw.lower()]], tgt_embeddings[tgt_word2id[tw.lower()]])
  else:
    dist = 1000

  print(tw +'\t'+str(dist))
  answer.write(tw +'\t'+str(dist)+'\n') 
